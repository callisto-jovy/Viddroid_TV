...
public class CardWatchablePresenter extends Presenter {

    private static final String TAG = "CardWatchablePresenter";
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        if (watchable.getCardImageUrl() != null) {
            cardView.setTitleText(watchable.getTitle());
            cardView.setMainImageDimensions(CARD_WIDTH, CARD_HEIGHT);

            Glide.with(viewHolder.view.getContext())
                    .load(watchable.getCardImageUrl())
                    .centerCrop()
